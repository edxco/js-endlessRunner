...
module.exports = {
  ...
  // eval() and a SourceMap is added as a DataUrl to the eval().     
  // Initially it is slow, but it provides fast rebuild speed and    
  // yields real files
  module: {
    rules: [{
        test: /\.js$/,
        // checks for files with .js extension in 
      ...
      // this loader will bundle them for you.
      {
        ...
        use: 'file-loader',
      }, // in case you need to use images, this loader will    
      // bundle them for you
    ],
  },
  plugins: [
    ...
    }), // specified the path where this plugin will delete the  
