...
module.exports = merge(base, {
  ...
  performance: {
    ...
    maxAssetSize: 900000,
    // These configure the file size limit
    ...
    minimizer: [
      new TerserPlugin({
        terserOptions: {
          output: {
            comments: false,
            // Tell Terser Plugin to remove
            // comments in your minified file
          },
        },
      }),
    ],
